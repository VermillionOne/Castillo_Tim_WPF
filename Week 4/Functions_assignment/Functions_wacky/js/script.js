...
var ornamentNumber = lateralSurface(radius, height, ornamentSize);

// This function is for finding the lateral surface area and number of ornaments for the Christmas tree
function lateralSurface(r, h, size){
